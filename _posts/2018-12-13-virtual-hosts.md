...
This should display the HTML of the It Works! page on your terminal.
...
Change the ServerName to your domain.
...
This creates a symbolic link to the site in /etc/apache2/sites-enabled to allow apache server to actually serve the site.

Reload apache2 to allow for new configurations to take effect:

sudo service apache2 reload

Test your configuration by downloading the HTML content of the site:
...
after the explanatory comments.

Add the following under the first Listen line:
